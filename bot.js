 ...
 **
رابط البوت | https://discordapp.com/oauth2/authorize?client_id=448170887288455168&scope=bot&permissions=2146958591
 **
`);
  message.author.sendEmbed(embed);
   }
...
client.on('ready',  () => {
  console.log('تم تشغيل :Pirates Bot  ');
